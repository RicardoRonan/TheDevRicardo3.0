      ...
      <div class="flex items-center justify-between">
        <div class="flex space-x-3">
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center px-3 py-1 border border-theme text-theme text-xs font-pixelify rounded-lg hover:bg-theme hover:text-theme-light transition-all duration-400 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:scale-105"
          >
