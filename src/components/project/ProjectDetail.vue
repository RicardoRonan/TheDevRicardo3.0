    ...
    >
      ...
      <div class="p-6">
        ...
        <div class="mb-6">
          ...
          <p class="font-pixelify text-base text-theme leading-relaxed mb-6">
            {{ project.description }}
          </p>
        </div>

        <!-- Project Brief -->
        <div v-if="project.brief" class="mb-6 bg-theme-light rounded-lg p-5 border border-theme">
          <h3 class="font-pixelify font-semibold text-lg text-theme mb-3 flex items-center">
          ...
          <div class="font-pixelify text-base text-theme leading-relaxed whitespace-pre-line">
            {{ project.brief }}
          </div>
        </div>
