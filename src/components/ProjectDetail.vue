      ...
      <div class="p-6">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
          <a 
            ...
            class="inline-flex items-center justify-center px-6 py-3 bg-accent-red text-white font-pixelify font-semibold rounded-lg hover:bg-red-700 transition-colors duration-200"
          >
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center justify-center px-6 py-3 border border-theme text-theme font-pixelify font-semibold rounded-lg hover:bg-theme-light transition-colors duration-200"
          >
